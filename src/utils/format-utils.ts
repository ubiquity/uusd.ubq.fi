 ...
 */
export function formatMintOutput(collateralNeeded: bigint, governanceNeeded: bigint, totalMinted: bigint, collateral: CollateralInfo): FormattedMintOutput {
  return {
 ...
 */
export function formatRedeemOutput(collateralRedeemed: bigint, governanceRedeemed: bigint, collateral: CollateralInfo): FormattedRedeemOutput {
  return {
 ...
 */
export function formatRedeemButtonText(amount: bigint, allowance: bigint, hasPendingRedemption: boolean): string {
